...
!(function (t, n) {
  ...
  var a = { a: 7, c: 6, h: 1, l: 2, m: 2, q: 4, s: 4, t: 2, v: 1, z: 0 },
    ...
    l = e(function (t, n, e, r) {
      ...
      i(this, 'x0', void 0),
        ...
        i(this, 'getPointAtLength', function (t) {
          var n =
            t / Math.sqrt(Math.pow(h.x0 - h.x1, 2) + Math.pow(h.y0 - h.y1, 2))
        ...
        i(this, 'getTangentAtLength', function (t) {
          var n = Math.sqrt(
            (h.x1 - h.x0) * (h.x1 - h.x0) + (h.y1 - h.y0) * (h.y1 - h.y0)
          )
      ...
      i(this, 'x0', void 0),
        ...
        i(this, 'getTangentAtLength', function (t) {
          ...
          var r =
              (n =
                t < u.length - e
                  ? u.getPointAtLength(t + e)
                  : u.getPointAtLength(t - e)).x - i.x,
            h = n.y - i.y,
            s = Math.sqrt(r * r + h * h)
          return t < u.length - e
            ? { x: -r / s, y: -h / s }
    ...
    f = function (t, n, e, i, r, h, s, a) {
      ...
      var g = (t.x - s.x) / 2,
        ...
        c =
          Math.pow(l.x, 2) / Math.pow(n, 2) + Math.pow(l.y, 2) / Math.pow(e, 2)
      c > 1 && ((n = Math.sqrt(c) * n), (e = Math.sqrt(c) * e))
      var f =
        (Math.pow(n, 2) * Math.pow(e, 2) -
          Math.pow(n, 2) * Math.pow(l.y, 2) -
          Math.pow(e, 2) * Math.pow(l.x, 2)) /
        (Math.pow(n, 2) * Math.pow(l.y, 2) + Math.pow(e, 2) * Math.pow(l.x, 2))
      f = f < 0 ? 0 : f
    ...
    y = function (t, n) {
      ...
      return (
        ...
        h.push([s, e]),
        (i += v(s, e)),
        r.push({ t: 1, arcLength: i }),
        { arcLength: i, arcLengthMap: r, approximationLines: h }
      )
    },
    p = function (t, n) {
      return ((t % n) + n) % n
  ...
  var N = function t(n, e, i) {
      ...
      if (0 === n) {
        h = 0
        for (var a = 0; a <= s; a++)
          h += A[s][a] * Math.pow(1 - e, s - a) * Math.pow(e, a) * i[a]
        return h
      }
      r = new Array(s)
    ...
    j = e(function (t, n, e, r, h, s, a, o) {
      ...
      i(this, 'a', void 0),
        ...
        void 0 !== a && void 0 !== o
          ? ((this.getArcLength = m),
            (this.getPoint = b),
            (this.getDerivative = P),
            (this.d = { x: a, y: o }))
          : ((this.getArcLength = q),
            (this.getPoint = T),
            (this.getDerivative = _),
            (this.d = { x: 0, y: 0 })),
    ...
    O = e(function (t) {
      ...
      i(this, 'length', 0),
        ...
        i(this, 'getPartAtLength', function (t) {
          ...
          for (
            var e = n.partial_lengths.length - 1;
            n.partial_lengths[e] >= t && e > 0;
          ...
          for (var t = [], e = 0; e < n.functions.length; e++)
            if (null !== n.functions[e]) {
              ...
              var i = {
                ...
                end: n.functions[e].getPointAtLength(
                  n.partial_lengths[e] - n.partial_lengths[e - 1]
                ),
      ...
      for (
            ...
            : (function (t) {
                ...
                return n.reduce(function (t, n) {
                  ...
                  if (
                    ('m' === i &&
                      h.length > 2 &&
                      (t.push([e].concat(r(h.splice(0, 2)))),
                      (i = 'l'),
                      (e = 'm' === e ? 'l' : 'L')),
                    'a' === i.toLowerCase() &&
                      (5 === h.length || 6 === h.length))
                  ) {
        ...
        if ('M' === h[y][0])
          (f = [(s = [h[y][1], h[y][2]])[0], s[1]]),
            this.functions.push(null),
            0 === y && (this.initial_point = { x: h[y][1], y: h[y][2] })
        else if ('m' === h[y][0])
          (f = [(s = [h[y][1] + s[0], h[y][2] + s[1]])[0], s[1]]),
            this.functions.push(null)
        else if ('L' === h[y][0])
          (this.length += Math.sqrt(
            Math.pow(s[0] - h[y][1], 2) + Math.pow(s[1] - h[y][2], 2)
          )),
            this.functions.push(new l(s[0], h[y][1], s[1], h[y][2])),
            (s = [h[y][1], h[y][2]])
        else if ('l' === h[y][0])
          (this.length += Math.sqrt(
            Math.pow(h[y][1], 2) + Math.pow(h[y][2], 2)
          )),
            this.functions.push(
              new l(s[0], h[y][1] + s[0], s[1], h[y][2] + s[1])
            ),
            (s = [h[y][1] + s[0], h[y][2] + s[1]])
        else if ('H' === h[y][0])
          (this.length += Math.abs(s[0] - h[y][1])),
            this.functions.push(new l(s[0], h[y][1], s[1], s[1])),
            (s[0] = h[y][1])
        else if ('h' === h[y][0])
          (this.length += Math.abs(h[y][1])),
            this.functions.push(new l(s[0], s[0] + h[y][1], s[1], s[1])),
            (s[0] = h[y][1] + s[0])
        else if ('V' === h[y][0])
          (this.length += Math.abs(s[1] - h[y][1])),
            this.functions.push(new l(s[0], s[0], s[1], h[y][1])),
            (s[1] = h[y][1])
        else if ('v' === h[y][0])
          (this.length += Math.abs(h[y][1])),
            this.functions.push(new l(s[0], s[0], s[1], s[1] + h[y][1])),
            (s[1] = h[y][1] + s[1])
        else if ('z' === h[y][0] || 'Z' === h[y][0])
          (this.length += Math.sqrt(
            Math.pow(f[0] - s[0], 2) + Math.pow(f[1] - s[1], 2)
          )),
            this.functions.push(new l(s[0], f[0], s[1], f[1])),
            (s = [f[0], f[1]])
        else if ('C' === h[y][0])
          (e = new j(
            s[0],
          ...
          ;(this.length += b.getTotalLength()),
            (s = [s[0] + h[y][6], s[1] + h[y][7]]),
