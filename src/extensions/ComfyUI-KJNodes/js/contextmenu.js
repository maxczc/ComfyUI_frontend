...
app.registerExtension({
        ...
        options.unshift(
          {
            content: 'Add GetNode',
            callback: () => {
              addNode('GetNode', this, { side: 'left', offset: 30 })
            }
          },
          {
            content: 'Add SetNode',
            callback: () => {
              addNode('SetNode', this, { side: 'right', offset: 30 })
            }
          }
        )
      })
  ...
  async setup(app) {
    ...
    app.ui.settings.addSetting({
      ...
      tooltip:
        'Adds Set/Get nodes to the top or bottom of the list of available node suggestions.',
    ...
    app.ui.settings.addSetting({
      ...
      name: 'KJNodes: 馃煝 Stoplight browser status icon 馃敶',
      defaultValue: false,
      type: 'boolean'
    })
  }
